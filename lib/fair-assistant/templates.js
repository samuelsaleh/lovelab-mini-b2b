...
export const FAIR_OUTREACH_TEMPLATES = [
  {
    ...
    // Headline stays generic — the gold subtitle below it already names the fair.
  ...
  },
  {
    ...
    lead_type: 'shop',
    subject: 'LoveLab Antwerp — our colourful diamonds at Vicenzaoro',
  ...
  },
  {
    ...
    lead_type: 'shop',
    subject: 'LoveLab Antwerp — our catalogue and B2B access, as promised',
  ...
  },
  {
    ...
    lead_type: 'agent',
    subject: 'LoveLab Antwerp — representing us in your territory?',
    headline: 'Partnership chat',
  ...
  },
  {
    ...
    lead_type: 'partner',
    subject: 'LoveLab Antwerp — an idea for {company}',
