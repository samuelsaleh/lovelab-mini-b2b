...
// Fixed CTA targets — same buttons appear in every fair email.
const VISIT_URL = 'https://lovelab.be/';
const B2B_LOGIN_URL = 'https://lovelab.be/b2b-signup';
    ...
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" style="margin:8px auto 24px auto;">
      <tr>
        <td style="padding:6px;">
          <a href="${VISIT_URL}" target="_blank" style="display:inline-block;padding:14px 28px;background-color:${BRAND.plum};color:#ffffff;text-decoration:none;border-radius:28px;font-size:14px;font-weight:600;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;letter-spacing:0.02em;mso-padding-alt:0;">
            Visit Our Website
          </a>
        </td>
        <td style="padding:6px;">
          <a href="${B2B_LOGIN_URL}" target="_blank" style="display:inline-block;padding:13px 28px;background-color:#ffffff;color:${BRAND.plum};text-decoration:none;border:1px solid ${BRAND.plum};border-radius:28px;font-size:14px;font-weight:600;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;letter-spacing:0.02em;mso-padding-alt:0;">
            B2B Login
          </a>
        </td>
      </tr>
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td align="center" style="padding:0 30px;">
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#ffffff;border:1px solid ${BRAND.border};border-radius:12px;">
            <tr>
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="background-color:#ffffff;max-width:600px;">
          ...
          <tr>
            <td align="center" style="padding:6px 50px 0 50px;">
              ...
              ${fairName ? `<p style="margin:0 0 22px 0;font-size:11px;color:${BRAND.gold};text-transform:uppercase;letter-spacing:0.2em;font-weight:700;text-align:center;">${esc(fairName)}</p>` : ''}
            </td>
          </tr>
          <tr>
                ...
                <tr>
                  <td align="center" width="33.33%" style="padding:10px;">
                    <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border:1px solid ${BRAND.border};border-radius:20px;width:100%;">
                      <tr><td align="center" style="padding:10px 5px;"><p style="margin:0;font-size:10px;color:${BRAND.textLight};">All taxes and duties included</p></td></tr>
                    </table>
                  </td>
                  <td align="center" width="33.33%" style="padding:10px;">
                    <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border:1px solid ${BRAND.border};border-radius:20px;width:100%;">
