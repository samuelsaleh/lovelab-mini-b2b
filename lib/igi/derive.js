...
/**
 * LoveLab's rule on IGI's stock (Sam, 10 Sept 2026). Below the level means
 * LoveLab order production themselves, whether or not IGI have noticed.
 * No level set means no opinion — 'fine', never an alert.
 */
