// Production sender is Alberto's verified LoveLab address. Falls back here
// only when the SENDER_EMAIL env var is unset — matches the branding decision
// we shipped: every outbound transactional email is from "LoveLab <alberto@>".
...
// ADMIN_NOTIFICATION_EMAIL is unset. Sam's personal Gmail is the safe fallback
