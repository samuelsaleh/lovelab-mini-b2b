...
export const COLLECTIONS = [
  ...
  { id: 'CUBIX', label: 'CUBIX', carats: ['0.05', '0.10', '0.20'], prices: [24, 34, 70], retail: [95, 145, 340], minC: 1, cord: 'nylon', housing: 'goldMetalNoRose', sizes: SIZES_SILK },
  ...
  { id: 'SSPF', label: 'SHAPY SPARKLE FANCY', carats: ['0.70', '1.00'], prices: [225, 300], retail: [550, 850], minC: 2, cord: 'silk', housing: 'sparkleProng', shapes: SHAPES_SHAPY_SPARKLE, sizes: SIZES_SILK },
  { id: 'SSRG', label: 'SHAPY SPARKLE RND G/H', carats: ['0.50', '0.70', '1.00'], prices: [115, 145, 205], retail: [290, 360, 500], minC: 2, cord: 'silkBraided', housing: 'sparkleProng', shapes: SHAPES_SHAPY_SPARKLE, sizes: SIZES_SILK },
  { id: 'SSRD', label: 'SHAPY SPARKLE RND D VVS', carats: ['0.50', '0.70', '1.00'], prices: [180, 200, 285], retail: [550, 650, 850], minC: 2, cord: 'silkBraided', housing: 'sparkleProng', shapes: SHAPES_SHAPY_SPARKLE, sizes: SIZES_SILK },
  { id: 'HOLY', label: 'HOLY (D VVS)', carats: ['0.50', '0.70', '1.00'], prices: [260, 425, 550], retail: [650, 1000, 1325], minC: 2, cord: 'nylon', housing: 'standard', shapes: SHAPES_HOLY, sizes: SIZES_NYLON },
]
...
export function calculateQuote(lines) {
  ...
  for (const l of lines) {
    ...
    for (const cfg of configs) {
      // Skip configs without a carat selection — they are incomplete and must not inflate totals
      ...
      const catalogPrice = col.prices[ci] ?? 0
