...
// Iconix silk bracelets default to non-braided: every Iconix order saved before
// the closure existed carries a grouped silk size (S/M, L/XL), which is the
// non-braided list — so the default keeps those rows valid instead of blanking
// their size the next time they are opened. CUTY / CUBIX have no default and
// still ask.
