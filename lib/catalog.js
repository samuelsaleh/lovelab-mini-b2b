...
// The list a NEW order starts on (Sam, 15 Sep 2026: only October is offered).
// DEFAULT_PRICELIST stays '2026' on purpose: it is the fallback for a saved
// document whose stored list is missing or unknown, and must not move.
export const NEW_ORDER_PRICELIST = '2026-10'
...
export {
  ...
  PREVIEW_PRICELISTS, RETIRED_PRICELISTS } from './collectionAccess.js'
