...
export const COLLECTIONS = [
  ...
  // Retired from the builder (Sam, Aug 2026) — kept so old quotes still price.
  ...
  { id: 'SSRD', label: 'SHAPY SPARKLE D VVS', carats: ['0.50', '0.70', '1.00'], certificate: 'igi',
    ...
    prices: {
      ...
      '2026': { inhouse: [200, 300, null], igi: [null, null, 400] },
    },
    retail: {
      '2025': { igi: [550, 650, 850] },
      '2026': { inhouse: [600, 900, null], igi: [null, null, 1200] },
    },
...
// Pulled from every picker (builder, order form, AI lists). The row stays in
// COLLECTIONS so a saved G/H quote still matches and prices. Sam, Aug 2026.
export const RETIRED_COLLECTION_IDS = new Set(['SSRG'])
