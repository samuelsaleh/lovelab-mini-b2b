...
export const COLLECTIONS = [
  ...
  { id: 'M5', label: 'MULTI FIVE', carats: ['0.25', '0.50'], certificate: 'igi',
    ...
    // Always XS–XL, even non-braided: the ERP has no S/M or L/XL SKU for Multi Five.
    minC: 2, cord: 'nylon', housing: 'goldMetal', sizes: SIZES_NYLON, hasClosure: true, sizesIgnoreClosure: true,
    allowedColors: ['Bordeaux', 'Red', 'Gold', 'Silver Grey', 'Black', 'Navy Blue', 'Royal Blue'] },
