...
export const HOUSING = {
  ...
  // MATCHY carries two diamonds, so the housing is a metal PAIR. Prong pairs
  // with the same metal keep the legacy single names (White = both prongs
  // white) so previously saved orders/drafts stay valid; the mixed pairs
  // (WY / WP / YP) are available in both settings.
  matchy: {
    bezel: [
