...
export const COLLECTIONS = [
  ...
  // and the full Shine cord palette. Prices = SSF 2026 +20% (B2B exact,
  // retail rounded up to nearest 5), identical across both pricelist years.
  // Same housing as the SSF bracelet (bezel/prong + Yellow/White/Pink metal);
  // the shape is chosen on the selection grid (shape cards) and locked per line.
  { id: 'SSF_NECK', label: 'SHAPY SHINE NECKLACE', productType: 'necklace', carats: ['0.10', '0.30', '0.50'], certificate: 'igi',
    ...
    minC: 2, cord: 'shine', housing: 'shapyShine', shapes: SHAPES_SHAPY_SHINE, sizes: SIZES_NECKLACE },
]
