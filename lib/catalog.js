...
export const HOUSING = {
  ...
  // 2026 range: 5-finish palette (argent rhodié, or jaune, or rose, rhodium gris, rhodium noir)
  fivePack: ['White', 'Yellow', 'Pink', 'Gray', 'Black'],
  multiThree: {
...
// Finish dimension for 2026 collections (Moonlight, Sienna). When a collection
// has `finishes: ['Shiny', 'Matte']`, the OrderForm renders a finish picker
// and persists it on the quote line. Collections without `finishes` (null) ship
// in Shiny only — no UI surfaced.
export const FINISHES = ['Shiny', 'Matte']

// 2026 cord-colour restriction: all new collections (Moonlight, Za-Ha, Luma,
// Luva, Linea, Sienna, Riviera) ship with this 5-colour cord palette only.
export const CORD_COLORS_2026 = ['Silver Grey', 'Gold', 'Black', 'Bordeaux', 'Brown']
...
export const COLLECTIONS = [
  { id: 'CUTY', label: 'CUTY', carats: ['0.05', '0.10', '0.20', '0.30'], certificate: 'both',
    ...
    retail: {
      ...
      '2026': { igi: [105, 155, 315, 430], inhouse: [95, 145, null, null] },
    },
  ...
  // ─── 2026 COLLECTIONS (Première Classe Paris drop) ─────────────────────────
  // Source: moonlightcoollection_25052026.xlsx + lovelab_tarif_2026.pdf.
  // All entries: 925 silver, IGI cert, housing=fivePack (5 finishes),
  // cord colours restricted to CORD_COLORS_2026, prices in EUR.
  // 2025 mirrors 2026 (these SKUs didn't exist in the 2025 pricelist; we
  // keep them populated for both years so the year toggle doesn't blank them).

  // Moonlight Halo — nylon, 3-stone halo cluster. Carat key = arrangement string.
  { id: 'MNH', label: 'MOONLIGHT HALO',
    carats: ['0.05-0.05-0.05', '0.05-0.10-0.05', '0.10-0.10-0.10', '0.10-0.20-0.10'],
    caratTotals: ['0.15', '0.20', '0.30', '0.40'],
    certificate: 'igi',
    prices: {
    ...
    minC: 2, cord: 'nylon', housing: 'fivePack', sizes: SIZES_NYLON,
    finishes: FINISHES, shape: 'Round',
    allowedColors: CORD_COLORS_2026 },

  // Moonlight Ora — nylon, solitaire round.
  { id: 'MNO', label: 'MOONLIGHT ORA',
    carats: ['0.05', '0.10', '0.20', '0.30'], certificate: 'igi',
    prices: {
  ...
  // Moonlight Full Moon — nylon, solitaire round (hero piece, brown cord + gold finish).
  { id: 'MFM', label: 'MOONLIGHT FULL MOON',
    carats: ['0.10', '0.30', '0.50', '0.70', '1.01'], certificate: 'igi',
    prices: {
  ...
  // Za-Ha — silk, marquise solitaire. Shiny only.
  { id: 'ZAHA', label: 'ZA-HA',
    carats: ['0.30'], certificate: 'igi',
    prices: {
      '2025': { igi: [110] },
      '2026': { igi: [110] },
    },
    ...
    minC: 2, cord: 'silk', housing: 'fivePack', sizes: SIZES_SILK,
    finishes: null, shape: 'Marquise',
    allowedColors: CORD_COLORS_2026 },

  // Luma — silk, 4× marquise. Shiny only.
  { id: 'LUMA', label: 'LUMA',
    carats: ['4x0.10'], caratTotals: ['0.40'], certificate: 'igi',
    prices: {
      '2025': { igi: [110] },
      '2026': { igi: [110] },
    },
  ...
  { id: 'LUVA', label: 'LUVA',
    ...
    minC: 2, cord: 'silk', housing: 'fivePack', sizes: SIZES_SILK,
    finishes: null, shape: 'Heart',
    allowedColors: CORD_COLORS_2026 },

  // Linea Three — nylon, 3× princess. Shiny only.
  { id: 'LIN3', label: 'LINEA THREE',
    carats: ['3x0.10'], caratTotals: ['0.30'], certificate: 'igi',
    prices: {
      '2025': { igi: [95] },
      '2026': { igi: [95] },
    },
    ...
    minC: 2, cord: 'nylon', housing: 'fivePack', sizes: SIZES_NYLON,
    finishes: null, shape: 'Princess',
    allowedColors: CORD_COLORS_2026 },

  // Linea Five — nylon, 5× princess. Shiny only.
  { id: 'LIN5', label: 'LINEA FIVE',
    carats: ['5x0.10'], caratTotals: ['0.50'], certificate: 'igi',
    prices: {
      '2025': { igi: [150] },
      '2026': { igi: [150] },
    },
  ...
  // Sienna One — silk, round solitaire.
  { id: 'SI1', label: 'SIENNA ONE',
    carats: ['0.10', '0.20', '0.30'], certificate: 'igi',
    prices: {
  ...
  // Sienna Two — Duo Poire, silk, 2× pear.
  { id: 'SI2P', label: 'SIENNA TWO (DUO POIRE)',
    carats: ['2x0.10'], caratTotals: ['0.20'], certificate: 'igi',
    prices: {
      '2025': { igi: [120] },
      '2026': { igi: [120] },
    },
    ...
    minC: 2, cord: 'silk', housing: 'fivePack', sizes: SIZES_SILK,
    finishes: FINISHES, shape: 'Pear',
    allowedColors: CORD_COLORS_2026 },

  // Sienna Three — Trio Brillant, silk, 3× round.
  { id: 'SI3', label: 'SIENNA THREE (TRIO BRILLANT)',
    carats: ['3x0.05', '3x0.10'], caratTotals: ['0.15', '0.30'], certificate: 'igi',
    prices: {
      '2025': { igi: [65, 120] },
      '2026': { igi: [65, 120] },
    },
  ...
  // Sienna Ligne 4 — silk, 4× round.
  { id: 'SI4', label: 'SIENNA LIGNE 4',
    carats: ['4x0.05', '4x0.10'], caratTotals: ['0.20', '0.40'], certificate: 'igi',
    prices: {
      '2025': { igi: [80, 150] },
      '2026': { igi: [80, 150] },
    },
  ...
  // Sienna Ligne 5 — silk, 5× round.
  { id: 'SI5', label: 'SIENNA LIGNE 5',
    carats: ['5x0.05', '5x0.10'], caratTotals: ['0.25', '0.50'], certificate: 'igi',
    prices: {
      '2025': { igi: [95, 170] },
      '2026': { igi: [95, 170] },
    },
  ...
  // Riviera Four — silk, 4× round. Shiny only.
  { id: 'RIV4', label: 'RIVIERA FOUR',
    carats: ['4x0.05', '4x0.10'], caratTotals: ['0.20', '0.40'], certificate: 'igi',
    prices: {
      '2025': { igi: [75, 95] },
      '2026': { igi: [75, 95] },
    ...
    minC: 2, cord: 'silk', housing: 'fivePack', sizes: SIZES_SILK,
    finishes: null, shape: 'Round',
    allowedColors: CORD_COLORS_2026 },

  // Riviera Eight — silk, 8× round. Shiny only.
  { id: 'RIV8', label: 'RIVIERA EIGHT',
    carats: ['8x0.05', '8x0.10'], caratTotals: ['0.40', '0.80'], certificate: 'igi',
    prices: {
      '2025': { igi: [95, 130] },
      '2026': { igi: [95, 130] },
    },
  ...
  for (const l of lines) {
    ...
    for (const cfg of configs) {
      ...
      qLines.push({
        ...
        // surfaced for collections that opt in via hasClosure (CUTY, CUBIX).
        // Other collections always emit null so OrderForm renders the N/A
        // em-dash instead of an empty editable cell.
