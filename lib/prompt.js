...
- closureType ("braided" or "nonBraided") for the nylon bracelets (CUTY, CUBIX, MULTI THREE/FOUR/FIVE, MATCHY FANCY, HOLY) — must be specified by user, never assume. SHAPY SHINE FANCY is always "braided" (never ask).
