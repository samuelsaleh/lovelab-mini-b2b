...
describe('new necklaces — packshots and labels', () => {
  ...
  it('keeps bracelet packshot fallbacks for necklaces without supplied photos', () => {
    expect(findPackshot('SSPF_NECK', { color: 'Black', shape: 'Round' })).toEqual(findPackshot('SSPF', { color: 'Black', shape: 'Round' }))
