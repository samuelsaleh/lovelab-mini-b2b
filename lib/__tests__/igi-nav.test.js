...
describe("the certificate application's own nav", () => {
  ...
  it('holds five screens, in the order the work actually happens', () => {
    // Sam, 16 Sept 2026: the Dashboard is two lists — collect, order — and nothing else.
  ...
  it('keeps the old addresses working', () => {
    ...
    // The front door is the two-list dashboard; matching is its own quiet
    // page again, reached from the foot of Models (16 Sept 2026).
    expect(page('')).toContain('CertificatesDashboardClient')
