...
describe('COLLECTIONS — hasClosure flag', () => {
  ...
  // Riviera is braided-only (Sam, Sep 2026): the picker is hidden and every row
  // is pinned to braided, so there is no non-braided default to fall back on.
  // Multi Three / Four / Five joined them: the non-braided option is gone.
