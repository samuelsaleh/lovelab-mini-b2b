...
describe('system prompt', () => {
  it('requires a structured answer and the DE / Stage / Friends merge', () => {
    expect(ANALYTICS_CHAT_SYSTEM).toContain('## Answer')
    expect(ANALYTICS_CHAT_SYSTEM).toContain('## Numbers')
    expect(ANALYTICS_CHAT_SYSTEM).toContain('## Breakdown')
    expect(ANALYTICS_CHAT_SYSTEM).toContain("FR's Friends")
    expect(ANALYTICS_CHAT_SYSTEM).toContain('DE / Deutschland')
    expect(ANALYTICS_CHAT_SYSTEM).not.toMatch(/export \{ ANALYTICS_TOOLS \}\s*$/)
  })
})
