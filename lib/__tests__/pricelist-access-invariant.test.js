...
describe('the October list is harmless to an agent who cannot sell what it reprices', () => {
  // Since 15 Sep 2026 the October list is the only one offered, so every agent
  // sees it. The invariant below still matters: it is what makes that safe.
  test('the agent is offered the October list', () => {
