...
const PDF_ROWS = [
  ...
  ['SSF',  '0.50', 'igi',     155, 600],
  ['SSPF', '0.70', 'igi',     400, 750],
  ['SSPF', '1.00', 'igi',     600, 1200],
  ['SSRG', '0.50', 'inhouse', 160, 350],
  ['SSRG', '0.70', 'inhouse', 200, 450],
  ['SSRG', '1.00', 'inhouse', 260, 700],
  ['SSRD', '0.50', 'inhouse', 300, 800],
  ['SSRD', '0.70', 'inhouse', 400, 1000],
  ['SSRD', '1.00', 'igi',     500, 1200],

  // ─── page 2 · MOONLIGHT (bracelet reprice Sep 2026) ───
  ['MNO', '0.05', 'igi', 67,  255],
  ['MNO', '0.10', 'igi', 85,  255],
  ['MNO', '0.30', 'igi', 120, 360],
  ['MNH', '0.20', 'igi', 100, 300],
  ['MNH', '0.40', 'igi', 165, 495],
  ['MNH', '0.70', 'igi', 200, 600],
  ['MNH', '1.01', 'igi', 320, 960],
  ['MFM', '0.10', 'igi', 70,  210],
  ['MFM', '0.20', 'igi', 90,  270],
  ['MFM', '0.30', 'igi', 120, 360],
  ['MFM', '0.50', 'igi', 250, 750],
  ['MFM', '0.70', 'igi', 300, 900],
  ['MFM', '1.01', 'igi', 460, 1380],

  // ─── pages 2-3 · SIENNA (SI1 kept; SI2–SI5 repriced) ───
  ['SI1',  '0.10', 'igi', 121, 475],
  ['SI1',  '0.30', 'igi', 172, 675],
  ['SI2P', '0.20', 'igi', 160, 480],
  ['SI3',  '0.15', 'igi', 90,  270],
  ['SI3',  '0.30', 'igi', 150, 450],
  ['SI4',  '0.20', 'igi', 120, 360],
  ['SI4',  '0.40', 'igi', 190, 570],
  ['SI5',  '0.25', 'igi', 130, 390],
  ['SI5',  '0.50', 'igi', 225, 675],

  // ─── page 3 · ICONIX (bracelet reprice Sep 2026) ───
  ['LUVA', '0.40', 'igi', 170, 510],
  ['LUMA', '0.40', 'igi', 150, 450],
  ['LIN3', '0.30', 'igi', 130, 390],
  ['LIN5', '0.50', 'igi', 195, 585],
  ['RIV4', '0.20', 'igi', 110, 330],
  ['RIV4', '0.40', 'igi', 130, 390],
  ['RIV8', '0.40', 'igi', 140, 420],
  ['RIV8', '0.80', 'igi', 175, 525],
  ['ZAHA', '0.30', 'igi', 140, 420],
  ...
  ['SSF_NECK',   '0.50', 'igi', 186, 720],
  ['SSPF_NECK',  '0.70', 'igi', 480, 900],
  ['SSPF_NECK',  '1.00', 'igi', 720, 1440],
