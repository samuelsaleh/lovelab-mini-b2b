...
describe('normalizeCountry', () => {
  ...
  test('UK → United Kingdom', () => expect(normalizeCountry('UK')).toBe('United Kingdom'))
  test('DE → Germany', () => expect(normalizeCountry('DE')).toBe('Germany'))
  test('FR → France', () => expect(normalizeCountry('FR')).toBe('France'))
  test('Deutschland → Germany', () => expect(normalizeCountry('Deutschland')).toBe('Germany'))
