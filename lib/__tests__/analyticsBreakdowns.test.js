...
describe('productChartHeight', () => {
  it('keeps a single row short', () => {
    expect(productChartHeight(1)).toBeLessThan(320)
    expect(productChartHeight(1)).toBeGreaterThan(0)
  })

  it('gives 28 rows more than 320px so labels are not squeezed', () => {
    expect(productChartHeight(28)).toBeGreaterThan(320)
  })

  it('does not go negative for empty or junk counts', () => {
    expect(productChartHeight(0)).toBeGreaterThan(0)
    expect(productChartHeight(-3)).toBeGreaterThan(0)
    expect(productChartHeight(null)).toBeGreaterThan(0)
  })
})
