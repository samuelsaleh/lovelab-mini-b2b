...
// Bracelet thread closure: required for collections that opt-in via
// `hasClosure` (currently CUTY and CUBIX). Stored values from the builder
// are 'braided' or 'nonBraided'.
function collectionRequiresClosure(collection) {
  return !!collection?.hasClosure
}
