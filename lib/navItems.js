 ...
 *
 * Five screens (Sam, 10 Sept 2026: "why is it so complex?"). It used to be
 * nine; the request is a column on Stock, the day-by-day view is a switch on
 * Movements, and matching sits under Models. IGI's side is a link in the
 * sidebar foot, not a screen of its own. The old addresses still redirect.
 *
