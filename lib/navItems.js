 ...
 *
 * Grouped, because the seven screens are not seven equal things: one tells you
 * where you stand, three are the daily loop, one is money, and two are setup
 * you touch once a quarter. `{ g }` entries are group headings, not links.
 *
...
export const CERTIFICATE_NAV = [
  ...
  { id: 'igi-side',  label: 'IGI’s side',     href: '/certificates/igi-view' },
  { g: 'Every day' },
  { id: 'requests',  label: 'New request',    href: '/certificates/requests' },
  { id: 'visits',    label: 'Visits',         href: '/certificates/visits' },
  { id: 'daily',     label: 'Daily history',  href: '/certificates/daily' },
  { id: 'stock',     label: 'Stock & alerts', href: '/certificates/stock' },
  { g: 'Money' },
  { id: 'invoices',  label: 'Invoices',       href: '/certificates/invoices' },
  { g: 'Setup' },
  { id: 'models',    label: 'Models & serials', href: '/certificates/models' },
  { id: 'matching',  label: 'Matching',       href: '/certificates/matching' },
]
