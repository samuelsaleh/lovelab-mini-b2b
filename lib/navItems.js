 ...
 * (is_agent — Sam, 15 Sep 2026) gets "My Sales", their own agent page with the
 * orders credited to them, their commissions and payments.
 */
export function getAdminNavItems(profile) {
  ...
  items.splice(at, 0, { id: 'my-sales', label: 'My Sales', href: '/agent' })
  return items
}
