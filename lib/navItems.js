 ...
 *
 * Four screens. Sam, 10 Sept 2026: "why is it so complex?" took it from nine
 * to five; Sam, 16 Sept 2026: "too much information" took the Dashboard away.
 * Stock is the front page now — one line per model, both sides, what to do.
 * The request is a column on Stock, the day-by-day view is a switch on
 * Movements, and matching is a link at the foot of Models. IGI's side is a
 * link in the sidebar foot, not a screen of its own. The old addresses still
 * redirect.
 *
