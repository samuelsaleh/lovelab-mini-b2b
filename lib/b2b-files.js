...
export const CATALOGUE_FILES = [
  ...
  {
    name: 'Oct EN_LoveLab_B2B_Catalogue (210 x 210 mm) (1).pdf',
    path: '/catalogues/English/Oct EN_LoveLab_B2B_Catalogue (210 x 210 mm) (1).pdf',
  },
  {
    name: 'DE — LoveLab B2B Catalogue.pdf',
    path: '/catalogues/DE_LoveLab_B2B_Catalogue.pdf',
  },
];
