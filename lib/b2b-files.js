...
export const CATALOGUE_FILES = [
  {
    name: 'Sept Fr LoveLab B2B Catalogue General (210 x 210 mm).pdf',
    path: '/catalogues/Francais/Sept Fr LoveLab B2B Catalogue General (210 x 210 mm).pdf',
  },
  {
    name: 'Sept Fr LoveLab B2B Catalogue (210 x 210 mm).pdf',
    path: '/catalogues/Francais/Sept Fr LoveLab B2B Catalogue (210 x 210 mm).pdf',
  },
  {
    name: '_Oct FR_LoveLab_B2B_Catalogue (210 x 210 mm).pdf',
    path: '/catalogues/Francais/_Oct FR_LoveLab_B2B_Catalogue (210 x 210 mm).pdf',
  },
  {
    name: 'Oct FR_LoveLab_B2B_Catalogue General (210 x 210 mm).pdf',
    path: '/catalogues/Francais/Oct FR_LoveLab_B2B_Catalogue General (210 x 210 mm).pdf',
  },
  {
    name: 'EN — LoveLab B2B Catalogue.pdf',
    path: '/catalogues/English/EN_LoveLab_B2B_Catalogue.pdf',
  },
  {
    name: 'Oct EN_LoveLab_B2B_Catalogue (210 x 210 mm).pdf',
    path: '/catalogues/English/Oct EN_LoveLab_B2B_Catalogue (210 x 210 mm).pdf',
  },
  {
    name: 'Oct DE_LoveLab_B2B_Catalogue General (210 x 210 mm).pdf',
    path: '/catalogues/Oct DE_LoveLab_B2B_Catalogue General (210 x 210 mm).pdf',
  },
];
