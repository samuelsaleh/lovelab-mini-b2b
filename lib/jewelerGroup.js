...
/** Synalia / groupement reporting is Nicolas-only (admins manage it on his page). */
export const SYNALIA_AGENT_EMAIL = 'nicolas.vial@ascension-france.com';

export function isSynaliaAgentEmail(email) {
  return String(email || '').trim().toLowerCase() === SYNALIA_AGENT_EMAIL;
}
