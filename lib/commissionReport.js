...
export function buildReportData({
  ...
  //
  // No date-window filter — the report is "everything ready to pay right now",
  // regardless of which month the order was placed or when the checkbox was ticked.
  // The periodStart/periodEnd/label are used only for the report header and filename.
