...
function extractJSON(raw) {
  ...
  // Strategy 3: Find the outermost { ... } and parse it
...
{"address":"","city":"","zip":"","country":"${country}","vat":""}`
...
{"address":"","city":"","zip":"","country":"${country}","vat":""}`
  ...
  console.log('[lookupCompany] Result (attempt 1):', attempt1.result)
  if (hasAnyAddress(attempt1.result)) return attempt1.result

  console.log('[lookupCompany] Empty address fields; retrying with alternate prompt.')
  const attempt2 = await runPerplexity(prompt2, { maxTokens: 350 })
  console.log('[lookupCompany] Result (attempt 2):', attempt2.result)
...
{"address":"","city":"","zip":"","country":"${country}","vat":""}`
    ...
    console.log('[lookupCompany] Empty address fields; trying citation-based fallback:', topCitation)
    const attempt3 = await runPerplexity(prompt3, { maxTokens: 350 })
    console.log('[lookupCompany] Result (attempt 3):', attempt3.result)
