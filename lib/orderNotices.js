...
import { getSenderFrom, getOrderNotificationRecipientsFor } from '@/lib/email';
...
export async function notifyOrderEvent(
  ...
  try {
    ...
    // Debbie and Dahlia are on every notice (Sam, 15 Sep 2026) — see lib/email.js.
    const recipients = getOrderNotificationRecipientsFor(document);
