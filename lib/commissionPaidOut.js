 ...
 *   2. Stored commission ids in the report snapshot (legacy reports created
...
export async function resolveCommissionIdsForReport(supabase, report) {
  ...
  // Do not settle by document_id alone. If the original commission row was
  // deleted and the order was re-saved, document matching can pay a replacement
  // row that was never included in this report.
  return directIds;
}
