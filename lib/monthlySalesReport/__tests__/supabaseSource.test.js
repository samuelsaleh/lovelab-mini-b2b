...
describe('normaliseSupabaseRows', () => {
  const rows = {
    ...
    events: [{ id: 'e1', name: 'Bijorhca', type: 'fair', start_date: '2026-08-06', end_date: '2026-08-08' }, { id: 'e2', name: 'Agent folder', type: 'agent' }],
    profiles: [{ id: 'a1', full_name: 'Sample Agent', email: 'agent@example.com' }],
    commissions: [
  ...
  it('marks fairs from events.type and names agents from profiles', () => {
    ...
    expect(m.agents).toEqual([{ id: 'a1', name: 'Sample Agent' }])
