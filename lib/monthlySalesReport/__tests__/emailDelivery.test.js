import { emailSalesReport, reportRecipients } from '../emailDelivery.js'
...
describe('no built-in recipient', () => {
  ...
  it('emails nobody unless recipients are configured, and exactly the configured list when they are', () => {
