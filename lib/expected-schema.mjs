 ...
 *   functions[]             — database functions the app or RLS policies use
 *
...
export const expectedSchema = {
  tables: [
...

    {
      ...
      checks: ['documents_order_channel_check', 'documents_status_check'],
...

    {
      ...
      uniqueIndexes: [
        {
          name: 'agent_payments_report_id_unique',
          columns: ['report_id'],
          predicate: 'report_id IS NOT NULL',
        },
      ],
    },
  ...
  functions: [
    ...
    { name: 'record_agent_report_payment', source: 'supabase-phase30-atomic-report-payments.sql' },
  ],
};
