  ...
  tables: [
    {
      ...
      columns: [
        ...
        { name: 'agent_language', type: 'text', source: 'supabase/migrations/20260922120000_agent_language.sql (check dropped in 20260922130000_agent_language_no_check.sql)' },
      ],
      checks: [
...

    {
      ...
      columns: [
        { name: 'id', type: 'uuid', source: 'supabase/migrations/20260909120000_email_deliveries.sql' },
        { name: 'resend_id', type: 'text', source: 'supabase/migrations/20260909120000_email_deliveries.sql' },
        { name: 'kind', type: 'text', source: 'supabase/migrations/20260909120000_email_deliveries.sql' },
        { name: 'document_id', type: 'uuid', source: 'supabase/migrations/20260909120000_email_deliveries.sql' },
        { name: 'draft_id', type: 'uuid', source: 'supabase/migrations/20260909120000_email_deliveries.sql' },
        { name: 'recipient', type: 'text', source: 'supabase/migrations/20260909120000_email_deliveries.sql' },
        { name: 'subject', type: 'text', source: 'supabase/migrations/20260909120000_email_deliveries.sql' },
        { name: 'status', type: 'text', source: 'supabase/migrations/20260909120000_email_deliveries.sql' },
        { name: 'detail', type: 'text', source: 'supabase/migrations/20260909120000_email_deliveries.sql' },
        { name: 'advice', type: 'text', source: 'supabase/migrations/20260909120000_email_deliveries.sql' },
        { name: 'bounce_type', type: 'text', source: 'supabase/migrations/20260909120000_email_deliveries.sql' },
        { name: 'bounce_subtype', type: 'text', source: 'supabase/migrations/20260909120000_email_deliveries.sql' },
        { name: 'sent_at', type: 'timestamp', source: 'supabase/migrations/20260909120000_email_deliveries.sql' },
        { name: 'last_event_at', type: 'timestamp', source: 'supabase/migrations/20260909120000_email_deliveries.sql' },
        { name: 'checked_at', type: 'timestamp', source: 'supabase/migrations/20260909120000_email_deliveries.sql' },
        { name: 'created_at', type: 'timestamp', source: 'supabase/migrations/20260909120000_email_deliveries.sql' },
        { name: 'updated_at', type: 'timestamp', source: 'supabase/migrations/20260909120000_email_deliveries.sql' },
      ],
      checks: ['email_deliveries_kind_check', 'email_deliveries_status_check'],
    },
    // ── LoveLab x IGI certificate module ────────────────────────────────────
    {
      ...
      columns: [
        ...
        { name: 'requested_by', type: 'uuid', source: 'supabase/migrations/20260910120000_igi_new_models.sql' },
        { name: 'requested_at', type: 'timestamp', source: 'supabase/migrations/20260910120000_igi_new_models.sql' },
        { name: 'numbered_by', type: 'uuid', source: 'supabase/migrations/20260910120000_igi_new_models.sql' },
        { name: 'numbered_at', type: 'timestamp', source: 'supabase/migrations/20260910120000_igi_new_models.sql' },
        { name: 'order_min', type: 'integer', source: 'supabase/migrations/20260910140000_igi_order_min.sql' },
        { name: 'shelf_alerted_at', type: 'timestamp', source: 'supabase/migrations/20260910140000_igi_order_min.sql' },
        { name: 'order_alerted_at', type: 'timestamp', source: 'supabase/migrations/20260910140000_igi_order_min.sql' },
      ],
      checks: [
...

    {
      name: 'igi_counts',
      columns: [
        { name: 'id', type: 'uuid', source: 'supabase/migrations/20260918140000_igi_counts.sql' },
        { name: 'model_id', type: 'uuid', source: 'supabase/migrations/20260918140000_igi_counts.sql' },
        { name: 'was', type: 'integer', source: 'supabase/migrations/20260918140000_igi_counts.sql' },
        { name: 'counted', type: 'integer', source: 'supabase/migrations/20260918140000_igi_counts.sql' },
        { name: 'delta', type: 'integer', source: 'supabase/migrations/20260918140000_igi_counts.sql' },
        { name: 'note', type: 'text', source: 'supabase/migrations/20260918140000_igi_counts.sql' },
        { name: 'counted_at', type: 'timestamp', source: 'supabase/migrations/20260918140000_igi_counts.sql' },
        { name: 'created_by', type: 'uuid', source: 'supabase/migrations/20260918140000_igi_counts.sql' },
      ],
      checks: ['igi_counts_delta_nonzero', 'igi_counts_delta_matches'],
    },

    {
      name: 'igi_digest_sends',
      columns: [
        { name: 'kind', type: 'text', source: 'supabase/migrations/20260925120000_igi_digest_sends.sql' },
        { name: 'sent_on', type: 'date', source: 'supabase/migrations/20260925120000_igi_digest_sends.sql' },
        { name: 'sent_at', type: 'timestamp', source: 'supabase/migrations/20260925120000_igi_digest_sends.sql' },
        { name: 'recipients', type: 'array', source: 'supabase/migrations/20260925120000_igi_digest_sends.sql' },
        { name: 'subject', type: 'text', source: 'supabase/migrations/20260925120000_igi_digest_sends.sql' },
      ],
    },

    {
      ...
      columns: [
        ...
        { name: 'correction', type: 'boolean', source: 'supabase/migrations/20260918120000_igi_visit_correction.sql' },
        { name: 'notified_at', type: 'timestamp', source: 'supabase/migrations/20260919120000_igi_visit_notified.sql' },
        { name: 'notify_error', type: 'text', source: 'supabase/migrations/20260919120000_igi_visit_notified.sql' },
    ...
    {
      name: 'igi_certificate_out_sync',
      columns: [
        { name: 'id', type: 'uuid', source: 'supabase/migrations/20260918120000_igi_certificate_out_sync.sql' },
        { name: 'erp_out_id', type: 'bigint', source: 'supabase/migrations/20260918120000_igi_certificate_out_sync.sql' },
        { name: 'invoice_no', type: 'text', source: 'supabase/migrations/20260918120000_igi_certificate_out_sync.sql' },
        { name: 'out_date', type: 'date', source: 'supabase/migrations/20260918120000_igi_certificate_out_sync.sql' },
        { name: 'party', type: 'text', source: 'supabase/migrations/20260918120000_igi_certificate_out_sync.sql' },
        { name: 'description', type: 'text', source: 'supabase/migrations/20260918120000_igi_certificate_out_sync.sql' },
        { name: 'pcs', type: 'numeric', source: 'supabase/migrations/20260918120000_igi_certificate_out_sync.sql' },
        { name: 'remark', type: 'text', source: 'supabase/migrations/20260918120000_igi_certificate_out_sync.sql' },
        { name: 'source', type: 'text', source: 'supabase/migrations/20260918120000_igi_certificate_out_sync.sql' },
        { name: 'external_ref', type: 'text', source: 'supabase/migrations/20260918120000_igi_certificate_out_sync.sql' },
        { name: 'model_id', type: 'uuid', source: 'supabase/migrations/20260918120000_igi_certificate_out_sync.sql' },
        { name: 'serial', type: 'text', source: 'supabase/migrations/20260918120000_igi_certificate_out_sync.sql' },
        { name: 'payload', type: 'jsonb', source: 'supabase/migrations/20260918120000_igi_certificate_out_sync.sql' },
        { name: 'synced_at', type: 'timestamp', source: 'supabase/migrations/20260918120000_igi_certificate_out_sync.sql' },
        { name: 'created_at', type: 'timestamp', source: 'supabase/migrations/20260918120000_igi_certificate_out_sync.sql' },
      ],
    },
    {
      name: 'igi_invoices',
