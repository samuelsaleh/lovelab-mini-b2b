  ...
  tables: [
    {
      ...
      checks: ['profiles_agent_status_check', 'profiles_commission_rate_check'],
    },
...

    {
      ...
      checks: ['documents_order_channel_check'],
...

    {
      ...
      uniqueIndexes: [
        {
          name: 'agent_commissions_agent_document_unique',
          columns: ['agent_id', 'document_id'],
