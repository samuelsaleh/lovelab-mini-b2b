...
| | |
|---|---|
| **Housing** | Attached: WWW, YYY, PPP · Loose: WWW, YYY, PPP, YWP |
| **Carats** | 0.15 / 0.30 / 0.60 / 0.90 |
| **2nd Biggest Carat** | 0.60 ct |
| **Cord** | Nylon |
| **Sizes** | XS, S, M, L, XL |
...
| **Prong** | White, Yellow, Pink, WY (White/Yellow), WP (White/Pink), YP (Yellow/Pink) |
...
Three products under this family, sharing the same shapes and housing type:

**Shapes (all 3 products):** Round, Pear, Oval, Heart, Princess, Cushion, Marquise, Emerald, Long Cushion

**Housing (all 3 products):** Prong only

**Sizes (all 3 products):** S/M, L/XL
...
### SHAPY SPARKLE RND G/H

| | |
|---|---|
| **Carats** | 0.50 / 0.70 / 1.00 |
| **2nd Biggest Carat** | 0.70 ct |
| **Cord** | Silk **or** Braided Nylon (user picks) |
...
| **Sizes** | XS, S, M, L, XL |
| **Shapes** | Cross, Hamsa, Star of David, Greek Cross |

**Colors (8):** Brown, Grey, Green, Ivory, Royal Blue, Pink, Black, Red
