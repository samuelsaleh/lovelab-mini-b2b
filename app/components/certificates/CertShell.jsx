 ...
 * only in the nav they are handed and the word under the logo.
 *
 * Props:
 *   nav      — [{ g: 'Group name' } | { id, label, href, badge }]
 *   home     — where the logo goes, and the route that counts as the root
 *   brand    — whose space this is, in the logo ("LoveLab", "IGI Antwerp")
 ...
 */
export default function CertShell({ nav, home, brand, title, banner, status, exit, children }) {
