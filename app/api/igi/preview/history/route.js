...
/**
 * GET /api/igi/preview/history — IGI's History, served to a LoveLab admin.
 *
...
export async function GET(request) {
  ...
  try {
    return NextResponse.json(historyView(await loadIgiWorld(auth.adminSupabase)));
  } catch (err) {
    return fail('IGI/Preview history', err, 'Failed to load IGI’s screen');
  }
}
